...
export function PieWithLegend({ data }: { data: Record<ExpenseCategory, number> | Record<IncomeCategory, number> }) {
  ...
  return (
    <div className="h-48 flex justify-center items-center gap-3 grid-cols-3">
